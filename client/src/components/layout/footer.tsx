    ...
    <footer className="bg-zinc-900/60 border-t border-zinc-800">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">DiseaseDetect</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-zinc-400">
                Email: support@diseasedetect.com
              </li>
              <li className="text-zinc-400">
        ...
        <div className="mt-8 pt-8 border-t border-zinc-800 text-center text-zinc-400">
          <p>&copy; {new Date().getFullYear()} DiseaseDetect. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
